...
namespace AutoMapper
{
    public  class Mapper
    {
        ...
        private  T DoMap<T>(object source, T destination)
        {
        ...
        private  bool IsCollection(object item, string nameOfProperty)
        {
        ...
        private  object AddAndMatch<T>(object sourceValue, T destination, PropertyInfo[] sourceProperties, Type propertyType)
        {
            ...
            return mapMethod.Invoke(this, new object[] { sourceValue });


        }

        private  void SetNullOrDefault(PropertyInfo property, object instance)
        {
